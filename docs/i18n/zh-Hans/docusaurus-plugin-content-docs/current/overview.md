...
evjs 是一个零配置的 React 全栈框架，基于 [TanStack Router](https://tanstack.com/router)、[TanStack Query](https://tanstack.com/query) 和 [Hono](https://hono.dev) 构建。提供无缝的开发体验，用于构建类型安全的全栈 Web 应用。
